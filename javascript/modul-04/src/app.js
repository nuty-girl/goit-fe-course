...
const notepad = {
  ...
  findNoteById(id) {
    ...
    /*Ищет заметку в массиве notes*Принимает: идентификатор заметки
  ...
  saveNote(note) {
    ...
    return note;
    /*Сохраняет заметку в массив notes*Принимает: объект заметки
 ...
 */
notepad.updateNotePriority('id-4', Priority.HIGH);
