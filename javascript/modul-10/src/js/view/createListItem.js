...
function createNoteFooter(priority) {
  ...
  const buttonDown = createActionButton(NOTE_ACTIONS.DECREASE_PRIORITY, ICON_TYPES.ARROW_DOWN);
  const buttonUp = createActionButton(NOTE_ACTIONS.INCREASE_PRIORITY, ICON_TYPES.ARROW_UP);
  ...
  noteFooter.append(noteSection1, span, noteSection2);
  return noteFooter;
}
